...
const serviceDrafts: ServiceDraft[] = [
  {
    ...
    intro: 'التأسيس يمشي مع البناء: نمدّ المواسير في السقف والجدران قبل اللياسة، ونركّب علب الأفياش والمفاتيح بالليزر عشان تطلع مستوية. بعدها نسحب الأسلاك ونوزّع الأحمال على لوحة القواطع، ونسلّمها لك جاهزة ومجرّبة قبل الدهان.',
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'إيه، البيوت والمحلات. وشقق وملاحق ومستودعات كمان. نفس الشغل، يختلف بس حجم اللوحة وتوزيع الأحمال.',
      },
      {
        question: 'المواد عليكم ولا عليّ؟',
        answer: 'زي ما تحب. نجيبها لك، أو تشتريها بنفسك وإحنا نركّب. بالمختصر نقولك المطلوب بالضبط قبل ما تشتري.',
      },
      {
  ...
  },
  {
    ...
    title: 'ثريا وسبوت',
    description: 'نركّبها ونوزّع النور',
    serviceType: 'ثريا وسبوت',
    seoDescription: 'تركيب ثريا وسبوت في مكة: تثبيت يتحمّل وزن الثريا، وتوزيع نور يغطي الغرفة بدون ظلال ولا زوايا مظلمة. نركّب ثرياتك حتى لو السقف عالي.',
  ...
  },
  {
    ...
    title: 'ليد مخفي',
    description: 'النور يبان، والشريط ما يبان',
    serviceType: 'ليد مخفي',
    seoDescription: 'تركيب ليد مخفي في مكة: مجرى مضبوط في الجبس أو خلف الكورنيش، نور متساوي، والشريط ما يبان. وفيه ليد ملوّن RGB وتحكّم من الجوال.',
    intro: 'النور يبان والشريط ما يبان. نجهّز المجرى في الجبس أو خلف الكورنيش، نمدّ الشريط بمسافة ثابتة، ونخفي المحوّل بمكان يوصله هوا وسهل للصيانة.',
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'إيه، وهذا الأفضل. لو نسّقنا مع الجبّاس من البداية يطلع المجرى مضبوط من أول مرة.',
      },
    ],
    gallery: [
      {
        src: '/images/services/led-geometric-ceiling.jpg',
        alt: 'سقف بأشكال ليد مخفي',
      },
      {
        src: '/images/services/led-ceiling-frame.jpg',
        alt: 'ليد مستطيل في السقف',
      },
      {
  ...
  },
  {
    ...
    serviceType: 'انتركوم',
    seoDescription: 'تركيب انتركوم في مكة: فيديو انتركوم بشاشة داخلية، تفتح الباب من مكانك، وفيه أنظمة لعمارة كاملة. ولو عندك قديم، نفحصه قبل ما تبدّله.',
  ...
  },
  {
    ...
    faqs: [
      {
        question: 'ليه نأسس من وقت البناء؟',
      ...
      },
      {
        ...
        answer: 'إيه. الكونسيلد يبغى دكت وسقف جبس ومساحة أكبر، ونقولك إذا سقفك يسمح ولا لأ.',
      },
      {
      ...
      },
      {
        ...
        answer: 'الأساس عندنا التأسيس. لو جاهز، نقدر نكمّل التركيب. كلّمنا وقول وضع الموقع.',
      },
    ],
    gallery: [
      {
        src: '/images/services/ac-outdoor-rough-in.jpg',
        alt: 'مواسير خارجة من الجدار',
      },
      {
  ...
  },
  {
    ...
    title: 'أعطال',
    description: 'نفحص، نقولك السبب، بعدين نصلح',
    serviceType: 'كشف أعطال كهرباء',

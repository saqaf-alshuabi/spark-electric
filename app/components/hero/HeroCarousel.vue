  ...
  >
    ...
    <div class="flex justify-center">
      <button
        ...
        :key="slide.src"
        type="button"
        class="group flex size-11 items-center justify-center focus-ring active:scale-[0.96]"
      ...
      >
        <span class="relative h-1 w-7">
          <span
            class="block h-full origin-[inline-start] rounded-full bg-muted/60 transition-transform duration-300 group-active:bg-muted can-hover:group-hover:bg-muted"

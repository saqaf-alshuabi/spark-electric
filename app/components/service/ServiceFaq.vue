    ...
    <UContainer class="stack-md items-center">
      ...
      <ul class="mx-auto stack-xs w-full max-w-3xl">
        ...
        >
          <details
            name="service-faq"
            class="group details-reveal rounded-xl border border-default/60 bg-default/40 transition-colors duration-300 ease-out open:bg-default active:bg-default can-hover:hover:bg-default"
          >
            <summary
